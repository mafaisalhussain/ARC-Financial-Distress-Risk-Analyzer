...
```json
{
  ...
  "cik": "0000047987",
  "fiscal_year_range": "2014–2023",
  "total_filings": 10,
  "latest_risk_score": 78.4,
  "latest_risk_tier": "CRITICAL",
  "latest_altman_z": 0.82,
  "latest_altman_zone": "Distress Zone",
  "counter_strategies": [
    {
      "strategy_detected": "Cash Burn Spiral",
      "description": "Operating Cash Flow is negative (-4.1% of assets) while the debt ratio is rising (+6.2% YoY)...",
  ...
  "shap_explanation": {
    "raise_drivers": [
      { "feature": "debt_ratio", "label": "Debt Ratio", "shap_value": 0.18, "direction": "raise" },
      { "feature": "operating_cf_ratio", "label": "Operating CF Ratio", "shap_value": 0.14, "direction": "raise" }
    ],
    "lower_drivers": [...]
  },
  "model_features": 35,
  "model_version": "LightGBM-v4-Optuna"
}
```
